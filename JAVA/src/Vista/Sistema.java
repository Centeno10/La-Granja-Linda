...
public final class Sistema extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbxRol.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Administrador", "Cajero", "Mesero", "Cocinero" }));
    ...
    private void btnPlatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPlatosActionPerformed
        jTabbedPane1.setSelectedIndex(7); //PLATOS
        LimpiarTable();
